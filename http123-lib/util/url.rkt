...
(module+ test
  ...
  (check-equal? (url->string (url-simplify-path "a/b/c")) "a/b/c")
  (check-equal? (url->string (url-simplify-path "a//b/c")) "a/b/c")
  (check-equal? (url->string (url-simplify-path "a/./b/./c")) "a/b/c")
  (check-equal? (url->string (url-simplify-path "a/z/y/../..//b/c")) "a/b/c")
  (check-equal? (url->string (url-simplify-path "../a/b/c")) "../a/b/c")
  (check-equal? (url->string (url-simplify-path "..//a//b/c")) "../a/b/c")
  (check-equal? (url->string (url-simplify-path "a/../../b/c")) "../b/c")
  ...
  (check-equal? (url->string (build-url "a/b/c/")) "a/b/c/")
  (check-equal? (url->string (build-url "a/b/c/" "")) "a/b/c/")
  (check-equal? (url->string (build-url "a/b/c/" "/")) "a/b/c/")
  (check-equal? (url->string (build-url "a/b/c/" ".")) "a/b/c/")
  (check-equal? (url->string (build-url "a/b/c/" "..")) "a/b/"))
